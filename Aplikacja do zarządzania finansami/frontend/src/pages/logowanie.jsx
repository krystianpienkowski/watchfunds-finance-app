  ...
  return (
    <div className="h-screen flex items-center justify-center bg-iceBlue">
      <div className="max-w-md w-full p-6 bg-white rounded shadow-lg">
        <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Logowanie</h2>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            {loading ? <BiLoader className="text-2xl text-white animate-spin" /> : "Zaloguj się"}
          </button>
        </form>
        ...
        <div className="mt-6">
          ...
          <div className="text-center">
            <Link to="/rejestracja" className="text-gray-500 hover:text-gray-700 transition duration-200">
