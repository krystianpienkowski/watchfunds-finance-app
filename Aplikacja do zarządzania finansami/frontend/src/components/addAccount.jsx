    ...
    <div className="fixed inset-0 flex items-center justify-center p-4">
      <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-500">Wybierz rodzaj konta</label>
            <select
          ...
          {/* Sekcja opisu konta */}
          <div>
            <label className="block text-sm font-medium text-gray-500">Wprowadź opis konta</label>
            <input
              type="text"
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? <BiLoader className="text-2xl text-white animate-spin" /> : "Stwórz konto"}
          </button>
        </form>
      </DialogPanel>
    </div>
